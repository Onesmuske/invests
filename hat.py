...
class Chatbot:
    ...
    def build_model(self, training, output):
        ...
        try:
            ...
            self.model.save_weights("models/model_weights.weights.h5")  # Corrected filename
    ...
    def respond(self, tag):
        for intent in self.data['intents']:
            if intent['tag'] == tag:
                if tag == 'stock_info':
                    return self.fetch_stock_info()  # Call method to fetch real-time stock information
                else:
